...
(async () => {
  ...
  if (isProd) {
    await mainWindow.loadURL('app://./conta/login');
  } else {
    const port = process.argv[2];
    await mainWindow.loadURL(`http://localhost:${port}/conta/login`);
